...
#---------------------------CONFIG EXCEL--------------------------
  1.015  LIB          COM xlWS = xlApp.Worksheets["PER1"];
...
#----------------CONFIG FILTER 100k-------------------
  ...
  1.077  IEEE         [@3]INP1:FILT OFF
  1.078  IEEE         INP:LEV:AUTO ON
  1.079  ENDIF
#------------DIVISOR----------------
  1.080  IF           Z1 == 1
  1.081  MATH         DIV = 1E-9
...
#------------------SAVE DATE----------------
  1.105  LIB          COM selectedCell2 = xlApp.Cells[LINHA,COLUNA];
  1.106  LIB          selectedCell2.Select();
  1.107  LIB          selectedCell2.FormulaR1C1 = [MEM];
  1.108  MATH         T = T + 1

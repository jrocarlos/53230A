...
#---------------------------CONFIG EXCEL--------------------------
  1.015  LIB          COM xlWS = xlApp.Worksheets["CH2"];
...
#-----------------SETUP----------------
  1.037  DISP         CONECTE A SAÍDA 1 DO GERADOR A ENTRADA DO CONTADOR 2
  1.037  DISP
...
#----------------CONFIG FILTER 100k-------------------
  ...
  1.087  IEEE         [@3]INP2:FILT OFF
  1.088  IEEE         INP2:LEV:AUTO ON
  1.089  ENDIF
#------------CONFIG IN METER----------------
...
#------------------SAVE DATE----------------
  1.097  LIB          COM selectedCell3 = xlApp.Cells[LINHA,COLUNA];
  1.098  LIB          selectedCell3.Select();
  1.099  LIB          selectedCell3.FormulaR1C1 = [MEM];
  1.100  MATH         T = T + 1
